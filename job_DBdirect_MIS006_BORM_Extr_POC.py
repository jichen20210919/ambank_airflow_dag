...
def netz_ODS_DTEP_INSP(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS netz_ODS_DTEP_INSP_joi_DTEP_INSP_v").show()
    ...
    netz_ODS_DTEP_INSP_joi_DTEP_INSP_v.write.mode("overwrite").saveAsTable("netz_ODS_DTEP_INSP_joi_DTEP_INSP_v")
...
def NETZ_SRC_BORM(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS NETZ_SRC_BORM_Left_v").show()
    ...
    NETZ_SRC_BORM_Left_v.write.mode("overwrite").saveAsTable("NETZ_SRC_BORM_Left_v")
...
def Transformer_46_joi_DTEP_INSP_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    netz_ODS_DTEP_INSP_joi_DTEP_INSP_v=spark.table('netz_ODS_DTEP_INSP_joi_DTEP_INSP_v')
    
    Transformer_46_joi_DTEP_INSP_Part_v=netz_ODS_DTEP_INSP_joi_DTEP_INSP_v
    
    spark.sql("DROP TABLE IF EXISTS Transformer_46_joi_DTEP_INSP_Part_v").show()
    ...
    Transformer_46_joi_DTEP_INSP_Part_v.write.mode("overwrite").saveAsTable("Transformer_46_joi_DTEP_INSP_Part_v")
...
def Join_40_Left_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    NETZ_SRC_BORM_Left_v=spark.table('NETZ_SRC_BORM_Left_v')
    
    Join_40_Left_Part_v=NETZ_SRC_BORM_Left_v
    
    spark.sql("DROP TABLE IF EXISTS Join_40_Left_Part_v").show()
    ...
    Join_40_Left_Part_v.write.mode("overwrite").saveAsTable("Join_40_Left_Part_v")
...
def Transformer_46(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS Transformer_46_DSLink48_v").show()
    ...
    Transformer_46_DSLink48_v.write.mode("overwrite").saveAsTable("Transformer_46_DSLink48_v")
...
def Join_40_DSLink48_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Transformer_46_DSLink48_v=spark.table('Transformer_46_DSLink48_v')
    
    Join_40_DSLink48_Part_v=Transformer_46_DSLink48_v
    
    spark.sql("DROP TABLE IF EXISTS Join_40_DSLink48_Part_v").show()
    ...
    Join_40_DSLink48_Part_v.write.mode("overwrite").saveAsTable("Join_40_DSLink48_Part_v")
...
def Join_40(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_40_Left_Part_v=spark.table('Join_40_Left_Part_v')
    
    Join_40_DSLink48_Part_v=spark.table('Join_40_DSLink48_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS Join_40_lnk_Source_v").show()
    ...
    Join_40_lnk_Source_v.write.mode("overwrite").saveAsTable("Join_40_lnk_Source_v")
...
def TRN_CONVERT_lnk_Source_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_40_lnk_Source_v=spark.table('Join_40_lnk_Source_v')
...
def TRN_CONVERT(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS TRN_CONVERT_lnk_BORM_Tgt_v").show()
    ...
    TRN_CONVERT_lnk_BORM_Tgt_v.write.mode("overwrite").saveAsTable("TRN_CONVERT_lnk_BORM_Tgt_v")
...
def DS_TGT_BORM_lnk_BORM_Tgt_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    TRN_CONVERT_lnk_BORM_Tgt_v=spark.table('TRN_CONVERT_lnk_BORM_Tgt_v')
    
    DS_TGT_BORM_lnk_BORM_Tgt_Part_v=TRN_CONVERT_lnk_BORM_Tgt_v
    
    spark.sql("DROP TABLE IF EXISTS DS_TGT_BORM_lnk_BORM_Tgt_Part_v").show()
    ...
    DS_TGT_BORM_lnk_BORM_Tgt_Part_v.write.mode("overwrite").saveAsTable("DS_TGT_BORM_lnk_BORM_Tgt_Part_v")
...
def DS_TGT_BORM(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    DS_TGT_BORM_lnk_BORM_Tgt_Part_v=spark.table('DS_TGT_BORM_lnk_BORM_Tgt_Part_v')
    ...
    spark.table("DS_TGT_BORM_lnk_BORM_Tgt_Part_v").write.mode("overwrite").format("parquet").save(locations)
