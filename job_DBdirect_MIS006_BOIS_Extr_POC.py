...
def NETZ_SRC_BASM(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS NETZ_SRC_BASM_srt_keys_v").show()
    ...
    NETZ_SRC_BASM_srt_keys_v.write.mode("overwrite").saveAsTable("NETZ_SRC_BASM_srt_keys_v")
...
def srt_keys_srt_keys_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    NETZ_SRC_BASM_srt_keys_v=spark.table('NETZ_SRC_BASM_srt_keys_v')
    
    srt_keys_srt_keys_Part_v=NETZ_SRC_BASM_srt_keys_v
    
    spark.sql("DROP TABLE IF EXISTS srt_keys_srt_keys_Part_v").show()
    ...
    srt_keys_srt_keys_Part_v.write.mode("overwrite").saveAsTable("srt_keys_srt_keys_Part_v")
...
def srt_keys(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    srt_keys_srt_keys_Part_v=spark.table('srt_keys_srt_keys_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS srt_keys_srt_KeyChange_v").show()
    ...
    srt_keys_srt_KeyChange_v.write.mode("overwrite").saveAsTable("srt_keys_srt_KeyChange_v")
...
def TRN_CONVERT(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    spark.sql("DROP TABLE IF EXISTS TRN_CONVERT_Left_v").show()
    ...
    TRN_CONVERT_Left_v.write.mode("overwrite").saveAsTable("TRN_CONVERT_Left_v")
...
def srt_KeyChange_srt_KeyChange_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    srt_keys_srt_KeyChange_v=spark.table('srt_keys_srt_KeyChange_v')
    
    srt_KeyChange_srt_KeyChange_Part_v=srt_keys_srt_KeyChange_v
    
    spark.sql("DROP TABLE IF EXISTS srt_KeyChange_srt_KeyChange_Part_v").show()
    ...
    srt_KeyChange_srt_KeyChange_Part_v.write.mode("overwrite").saveAsTable("srt_KeyChange_srt_KeyChange_Part_v")
...
def Join_57_Left_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    TRN_CONVERT_Left_v=spark.table('TRN_CONVERT_Left_v')
    
    Join_57_Left_Part_v=TRN_CONVERT_Left_v
    
    spark.sql("DROP TABLE IF EXISTS Join_57_Left_Part_v").show()
    ...
    Join_57_Left_Part_v.write.mode("overwrite").saveAsTable("Join_57_Left_Part_v")
...
def srt_KeyChange(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    srt_KeyChange_srt_KeyChange_Part_v=spark.table('srt_KeyChange_srt_KeyChange_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS srt_KeyChange_fil_KeyChange_v").show()
    ...
    srt_KeyChange_fil_KeyChange_v.write.mode("overwrite").saveAsTable("srt_KeyChange_fil_KeyChange_v")
...
def fil_KeyChange_fil_KeyChange_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    srt_KeyChange_fil_KeyChange_v=spark.table('srt_KeyChange_fil_KeyChange_v')
    
    fil_KeyChange_fil_KeyChange_Part_v=srt_KeyChange_fil_KeyChange_v
    
    spark.sql("DROP TABLE IF EXISTS fil_KeyChange_fil_KeyChange_Part_v").show()
    ...
    fil_KeyChange_fil_KeyChange_Part_v.write.mode("overwrite").saveAsTable("fil_KeyChange_fil_KeyChange_Part_v")
...
def fil_KeyChange(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    fil_KeyChange_fil_KeyChange_Part_v=spark.table('fil_KeyChange_fil_KeyChange_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS fil_KeyChange_DSLink148_v").show()
    ...
    fil_KeyChange_DSLink148_v.write.mode("overwrite").saveAsTable("fil_KeyChange_DSLink148_v")
...
def Copy_149_DSLink148_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    fil_KeyChange_DSLink148_v=spark.table('fil_KeyChange_DSLink148_v')
    
    Copy_149_DSLink148_Part_v=fil_KeyChange_DSLink148_v
    
    spark.sql("DROP TABLE IF EXISTS Copy_149_DSLink148_Part_v").show()
    ...
    Copy_149_DSLink148_Part_v.write.mode("overwrite").saveAsTable("Copy_149_DSLink148_Part_v")
...
def Copy_149(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Copy_149_DSLink148_Part_v=spark.table('Copy_149_DSLink148_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS Copy_149_Right_v").show()
    ...
    Copy_149_Right_v.write.mode("overwrite").saveAsTable("Copy_149_Right_v")
    ...
    spark.sql("DROP TABLE IF EXISTS Copy_149_Penalty_v").show()
    ...
    Copy_149_Penalty_v.write.mode("overwrite").saveAsTable("Copy_149_Penalty_v")
...
def Join_57_Right_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Copy_149_Right_v=spark.table('Copy_149_Right_v')
    
    Join_57_Right_Part_v=Copy_149_Right_v
    
    spark.sql("DROP TABLE IF EXISTS Join_57_Right_Part_v").show()
    ...
    Join_57_Right_Part_v.write.mode("overwrite").saveAsTable("Join_57_Right_Part_v")
...
def Join_152_Penalty_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Copy_149_Penalty_v=spark.table('Copy_149_Penalty_v')
    
    Join_152_Penalty_Part_v=Copy_149_Penalty_v
    
    spark.sql("DROP TABLE IF EXISTS Join_152_Penalty_Part_v").show()
    ...
    Join_152_Penalty_Part_v.write.mode("overwrite").saveAsTable("Join_152_Penalty_Part_v")
...
def Join_57(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_57_Left_Part_v=spark.table('Join_57_Left_Part_v')
    
    Join_57_Right_Part_v=spark.table('Join_57_Right_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS Join_57_P_Join_v").show()
    ...
    Join_57_P_Join_v.write.mode("overwrite").saveAsTable("Join_57_P_Join_v")
...
def Join_152_P_Join_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_57_P_Join_v=spark.table('Join_57_P_Join_v')
    
    Join_152_P_Join_Part_v=Join_57_P_Join_v
    
    spark.sql("DROP TABLE IF EXISTS Join_152_P_Join_Part_v").show()
    ...
    Join_152_P_Join_Part_v.write.mode("overwrite").saveAsTable("Join_152_P_Join_Part_v")
...
def Join_152(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_152_P_Join_Part_v=spark.table('Join_152_P_Join_Part_v')
    
    Join_152_Penalty_Part_v=spark.table('Join_152_Penalty_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS Join_152_LnkJoin_v").show()
    ...
    Join_152_LnkJoin_v.write.mode("overwrite").saveAsTable("Join_152_LnkJoin_v")
...
def Transformer_73_LnkJoin_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Join_152_LnkJoin_v=spark.table('Join_152_LnkJoin_v')
    
    Transformer_73_LnkJoin_Part_v=Join_152_LnkJoin_v
    
    spark.sql("DROP TABLE IF EXISTS Transformer_73_LnkJoin_Part_v").show()
    ...
    Transformer_73_LnkJoin_Part_v.write.mode("overwrite").saveAsTable("Transformer_73_LnkJoin_Part_v")
...
def Transformer_73(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Transformer_73_LnkJoin_Part_v=spark.table('Transformer_73_LnkJoin_Part_v')
    ...
    spark.sql("DROP TABLE IF EXISTS Transformer_73_lnk_BOIS_Tgt_v").show()
    ...
    Transformer_73_lnk_BOIS_Tgt_v.write.mode("overwrite").saveAsTable("Transformer_73_lnk_BOIS_Tgt_v")
...
def TGT_BASM_BOIS_lnk_BOIS_Tgt_Part(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    Transformer_73_lnk_BOIS_Tgt_v=spark.table('Transformer_73_lnk_BOIS_Tgt_v')
    
    TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v=Transformer_73_lnk_BOIS_Tgt_v
    
    spark.sql("DROP TABLE IF EXISTS TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v").show()
    ...
    TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v.write.mode("overwrite").saveAsTable("TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v")
...
def TGT_BASM_BOIS(spark: SparkSession, sc: SparkContext, **kw_args):
    ...
    TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v=spark.table('TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v')
    ...
    spark.table("TGT_BASM_BOIS_lnk_BOIS_Tgt_Part_v").write.mode("overwrite").format("parquet").save(locations)
